                ...
                <div class="stats">
                    <div class="box">
                        <div class="cases mini-card">
                            ...
                            <div id="tCases"><?php echo $appDataRef->getChild('covStatus/cases')->getValue(); ?></div>
                        </div>
                        <div class="tested mini-card">
                            <h3>Total Tested</h3><br>
                            <div id="tTested"><?php echo $appDataRef->getChild('covStatus/tested')->getValue(); ?></div>
                        </div>
                        <div class="recoveries mini-card">
                            <h3>Total Recoveries</h3><br>
                            <div id="tRecoveries"><?php echo $appDataRef->getChild('covStatus/recoveries')->getValue(); ?></div>
                        </div>
                        <div class="deaths mini-card">
                            <h3>Total Deaths</h3><br>
                            <div id="tDeaths"><?php echo $appDataRef->getChild('covStatus/death')->getValue(); ?></div>
                        </div>
                        <div class="newCases mini-card">
                            <h3>New Cases</h3><br>
                            <div id="nCases"><?php echo $appDataRef->getChild('covStatus/newCases')->getValue(); ?></div>
                        </div>
                        <div class="activeCases mini-card">
                            <h3>Total Active</h3><br>
                            <div id="tActive"><?php echo $appDataRef->getChild('covStatus/active')->getValue(); ?></div>
                        </div>
                    </div>
                </div>
                <div class="daily-cases">
                    ...
                    <p>
                        <a href="https://www.facebook.com/DagupanPIO">
                            <img src="<?php echo $appDataRef->getChild('links/daily')->getValue() ?>" class="right-data" alt="No DATA found" onerror="//this.src='img/undefined.jpg'">
                        </a>
                    </p>
